...
namespace UniAttend.Core.Interfaces.Repositories
{
    public interface IAbsenceAlertRepository : IRepository<AbsenceAlert>
    {
        ...
        Task<IEnumerable<AbsenceAlert>> GetByGroupIdAsync(int groupId, CancellationToken cancellationToken = default);
        ...
        Task<bool> HasActiveAlertAsync(int studentId, int groupId, CancellationToken cancellationToken = default);
    }
}